...
In ~\cite{tamizi2023review, LIU2023120254}, the methods are divided into two categories, Classical Approaches, which include Cell Decomposition, Sampling-based,  
...
different sensors and get a more accurate position. This method is called Odometry or sometimes, Dead Reckoning.
\paragraph{}Odometry alone cannot be used to get the robot's position as it is prone to drift over time \cite{odom1}, 
...
\paragraph{}In ~\cite{APFAPP}, the authors present a unified trajectory planning and tracking framework for 
...
\paragraph{}To summarize, the tractor-trailer pesticide spraying robot proposed in this 
...
To control the robot, the most used options would be the optimal controllers like 
...
and especially in the context of Smart Agriculture. A list of the algorithms used in tractor--trailer and 
articulated robotic systems considered in this section is provided in Table~\ref{tab:applications_2_5_2}.

\begin{table}[htbp]
\centering
\caption{Applications of tractor-trailer and articulated robotic systems}
\label{tab:applications_2_5_2}
\begin{tabular}{|c|l|l|l|l|}
\hline
\textbf{Ref.} & \textbf{System} & \textbf{Planner} & \textbf{Path Tracker}  \\
\hline
{~\cite{theman}} & General Tractor-trailer & Hybrid Voronoi A* & \gls{PP}  \\
\hline
{~\cite{mpconly}} & General Tractor-trailer & N/A & \gls{MPC} \\
\hline
{~\cite{ttex3}} & General Tractor-trailer & Exact planner &  N/A \\
\hline
{~\cite{APFAPP}} & General Tractor-trailer & \gls{APF} & \gls{MPC}  \\
\hline
{~\cite{lastapp}} & Transport truck & N/A & Optimal Controller  \\
\hline
\end{tabular}
\end{table}
